...
def parse_next_command(read, bmsfile, strict = True):
        ...
        if value <= 0x7F: 
            ...
            elif controlEventID == 0x92: # Unknown
                unknown1 = read.short()
                unknown2 = read.byte()
                
                args = (unknown1, unknown2)
            
            elif controlEventID == 0x94: # Unknown
                unknown1 = read.short()
            ...
            elif controlEventID == 0xAF: # Unknown
                unknown1 = read.byte()
                unknown2 = read.byte()
                unknown3 = read.byte()
            ...
            elif controlEventID == 0xB3: # Unknown
                unknown1 = read.short()
                
                args = (unknown1, )
                
            elif controlEventID == 0xB4: # Unknown
                unknown1 = read.short()
            ...
            elif controlEventID == 0xC9: # Unknown
                unknown1 = read.short()
                
                args = (unknown1, )
            
            elif controlEventID == 0xCA: # Unknown
                pass
            ...
            elif controlEventID == 0xCD: # Unknown
                unknown1 = read.byte()
            ...
            #elif controlEventID == 0xDE: # Unknown
            #    unknown1 = 
            
            elif controlEventID == 0xDD: # Unknown
                unknown1 = read.byte()
                unknown2 = read.short()
            ...
            elif controlEventID == 0xEB: # Unknown
                unknownData = read.byteArray(5)
            ...
            elif controlEventID == 0xFA: # Unknown
                unknown1 = read.short()
                
                args = (unknown1, )
            
            elif controlEventID == 0xFB: # Unknown
                # This could actually be data with variable length,
                # but more examples will need to be found to confirm that.
                
                bin_data = read.byteArray(7*4)
                unknown1 = read.byte()
                unknown2 = read.short()
                
                args = (bin_data, unknown1, unknown2)
